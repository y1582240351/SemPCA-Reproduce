...
class Preprocessor:
    ...
    def process(self, dataset, parsing, template_encoding, cut_func):
        ...
        if dataset == 'HDFS':
            ...
            dataloader = SpiritLoader(in_file=os.path.join(PROJECT_ROOT, 'datasets/Spirit/Spirit.log'),
                                      semantic_repr_func=template_encoding)
...
if __name__ == '__main__':
    ...
    processor.process(dataset='Spirit', parsing='IBM', template_encoding=template_encoder.present, cut_func=cut_by_613)
    pass
